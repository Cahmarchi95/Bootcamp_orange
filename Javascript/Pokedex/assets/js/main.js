...
//Carrega mais pokemons ao clicar no botão
...
function convertPokemonToLi(pokemon) {
  return `
    <button id="${pokemon.number}" class='pokemon-card' onclick='openModal(${
    pokemon.number
  })'>
...
function openModal(pokemonId) {
  ...
  elements.forEach((e) => {
    if (e.classList.contains("selected")) id = e.id;
  });
  ...
  //Deixa a barra de rolagem visível ao voltar para a listagem de pokemóns
...
function buildModal(pokemon) {
  return `
    ...
    <div class="detailsModal">
        <ul class="menuModal">
            <button id="menu1" class="selected" onclick="menuSelector('menu1', '${
              pokemon.number
            }')">
                <li>About</li>
            </button>
            <button id="menu2" class="" onclick="menuSelector('menu2', '${
              pokemon.number
            }')">
                <li>Base Stats</li>
            </button>
            <button id="menu3" class="" onclick="menuSelector('menu3', '${
              pokemon.number
            }')">
                <li>Evolution Chain</li>
            </button>
            <button id="menu4" class="" onclick="menuSelector('menu4', '${
              pokemon.number
            }')">
                <li>Moves</li>
            </button>
...
function formatData() {
  ...
  let newWeight =
    weightText.substring(0, weightText.length - 1) +
    "." +
    weightText.substring(weightText.length - 1);
...
function menuSelector(id, pokemonId) {
  ...
  elements.forEach((e) => {
    if (e.classList.contains("selected")) selected = e.id;
  });
